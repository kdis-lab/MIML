...
* [*mavenProject*](https://github.com/kdis-lab/MIML/tree/master/mavenProject). Contains the distribution of the MIML library as a Maven project with the following folders:  
