...
* *main folder*. Contains all the project as wekll as a copy of the [user manual](https://github.com/kdis-lab/MIML/blob/master/MIML-UserManual.pdf)..
* [*apidoc*](https://github.com/kdis-lab/MIML/tree/master/apidoc). Contains the documentation of the API in html format.
...
* [*data*](https://github.com/kdis-lab/MIML/tree/master/data). Contains some examples of datasets.
...
* [*userManual*](https://github.com/kdis-lab/MIML/tree/master/userManual). Contains the user manual.
