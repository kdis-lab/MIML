...
* [*dist*](https://github.com/kdis-lab/MIML/tree/master/dist). The *jar* file with all its dependences.
...
Before downloading the library, it is necessary to have Java 1.8 installed. Besides, these following versions of dependences are needed:
|Dependence|Version|
|-----------|-----------|
|Weka|3.7.10|
|Mulan|1.5|
