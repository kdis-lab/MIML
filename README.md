...
* [*mavenProject*](https://github.com/kdis-lab/MIML/tree/master/mavenProject). Contains the distribution of the MIML library as a Maven project with the following items:  
  ...
  * [*data*](https://github.com/kdis-lab/MIML/tree/master/mavenProject/data). Contains some examples of datasets. Particularly, birds dataset in included with the distribution of the librery.
