...
* [*user's manual*](https://github.com/kdis-lab/MIML/blob/master/MIML-UserManual.pdf). The user's manual.
* [*dist*](). The jar file with.....
* [*javaProject*](https://github.com/kdis-lab/MIML/tree/master/javaProject). Contains the distribution of the MIML library as a common Java project with the following items:
  * [*apidoc*](https://github.com/kdis-lab/MIML/tree/master/javaProject/apidoc). Contains the javadoc documentation of the API in html format.
  ...
  * [*data*](https://github.com/kdis-lab/MIML/tree/master/javaProject/data). Contains some examples of datasets. Particularly, birds dataset in included with the distribution of the librery.
  * [*dist*](https://github.com/kdis-lab/MIML/tree/master/javaProject/dist). Contains the distribution files.
  * [*results*](https://github.com/kdis-lab/MIML/tree/master/javaProject/results). Contains the file reports generated by each example in configurations folder.
  * [*src*](https://github.com/kdis-lab/MIML/tree/master/javaProject/src). Contains the source code of the distribution.
  * [*lib*](https://github.com/kdis-lab/MIML/tree/master/javaProject/lib). Contains the jar libraries required by MIML library.
  * [*userManual*](https://github.com/kdis-lab/MIML/tree/master/javaProject/userManual). Copy of the user's manual.
  
* [*mavenProject*](https://github.com/kdis-lab/MIML/tree/master/mavenProject). Contains the distribution of the MIML library as a Maven project with the following items:  
  * [*apidoc*](https://github.com/kdis-lab/MIML/tree/master/mavenProject/apidoc). Contains the javadoc documentation of the API in html format.
  * [*configurations*](https://github.com/kdis-lab/MIML/tree/master/mavenProject/configurations). Contains an example of *xml* configuration file for each of the algorithms included in the library.
  * [*data*](https://github.com/kdis-lab/MIML/tree/master/mavenProject/data). Contains some examples of datasets. Particularly, birds dataset in included with the distribution of the library.
  * [*dist*](https://github.com/kdis-lab/MIML/tree/master/mavenProject/dist). Contains the distribution files.
  * [*results*](https://github.com/kdis-lab/MIML/tree/master/mavenProject/results). Contains the file reports generated by each example in configurations folder.
  * [*src*](https://github.com/kdis-lab/MIML/tree/master/mavenProject/src). Contains de source code of the distribution.
  * [*userManual*](https://github.com/kdis-lab/MIML/tree/master/mavenProject/userManual). Copy of the user's manual.
